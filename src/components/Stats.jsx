                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8">
                    {stats.map((stat, index) => (
                        <motion.div
                            ...
                            className="group relative p-5 glass-card rounded-2xl border-white/5 hover:border-primary/20 transition-all duration-300 h-full"
                        >
                            <div className="absolute top-0 right-0 p-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                <div className="size-1 bg-primary rounded-full animate-ping"></div>
                            </div>

                            <span className="text-primary text-[10px] font-bold mb-2 block">
                                {stat.label}
                            </span>
                            ...
                            <div className="mt-4 w-0 group-hover:w-full h-[1px] bg-primary/30 transition-all duration-500"></div>
                        </motion.div>
                    ))}
                </div>
            </div>
