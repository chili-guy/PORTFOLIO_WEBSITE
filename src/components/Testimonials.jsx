                        ...
                        >
                            ...
                            <div className="pt-8 border-t border-white/5 mt-auto">
                                ...
                                <div className="flex items-center gap-3">
                                    <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest bg-white/5 px-2 py-1 rounded">{review.client}</span>
                    ...
                    <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }} viewport={{ once: true }} className="relative w-full max-w-2xl">
                        ...
                        <div className="relative glass-card rounded-2xl border border-white/5 overflow-hidden">
                            ...
                            <div className="px-10 py-10 flex flex-col items-center text-center gap-5">
                                ...
                                <a href={`https://wa.me/5591991266136?text=${encodeURIComponent(t.testimonials.inlineCta.waMsg)}`} target="_blank" rel="noopener noreferrer" className="button-primary h-13 px-10 text-xs tracking-[0.2em] font-black shadow-[0_0_30px_rgba(242,185,13,0.2)] hover:shadow-[0_0_50px_rgba(242,185,13,0.35)] flex items-center gap-3 group mt-1">
