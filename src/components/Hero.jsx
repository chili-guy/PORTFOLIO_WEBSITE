            ...
            <div className="mx-auto max-w-7xl px-6 w-full h-full flex flex-col pt-8 md:pt-32 pb-24 relative z-10">
                ...
                <div className="flex flex-col items-start w-full">
                    ...
                    <motion.div
                        ...
                        className="max-w-2xl lg:max-w-4xl text-left"
                    >
                        <h1 className="text-5xl sm:text-6xl lg:text-8xl font-black leading-[0.95] text-white tracking-tighter">
                            {t.hero.title1} <br />
                ...
                <div className="flex flex-col items-end w-full mt-8 md:mt-16 self-end">
                    ...
                    >
                        <div className="max-w-xl">
                            <div className="p-6 md:p-10 bg-black/30 backdrop-blur-2xl border-r-2 border-primary/50 text-right">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto">
                            ...
                            <a
                                ...
                                className="button-secondary w-full sm:w-auto h-16 px-10 group inline-flex items-center justify-center gap-3 rounded-none uppercase tracking-[0.2em] text-[11px] font-black border border-white/20 hover:border-primary hover:text-primary transition-all bg-black/40 backdrop-blur-md"
                            >
                                {t.hero.ctaSecondary}
