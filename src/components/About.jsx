                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-6">
                            <a
                                ...
                                className="button-primary h-14 px-8 text-xs font-black tracking-widest flex items-center justify-center gap-3 rounded-full"
                            >
                            ...
                            <a
                                href="#projects"
                                className="button-secondary h-14 px-8 text-xs font-black tracking-widest flex items-center justify-center rounded-full border border-white/10 hover:bg-white/5 transition-all uppercase"
                            >
                                {t.aboutContent.more}
                            </a>
                        </div>
