...
import { ArrowUpRight, ArrowRight, ChevronLeft, ChevronRight, Lock, Globe, MessageCircle } from 'lucide-react';
        ...
        <section className="py-8 lg:py-14 relative overflow-hidden" id="projects">
            <div className="mx-auto max-w-7xl px-6">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="relative mt-4 rounded-2xl border border-white/5 bg-surface-dark/60 backdrop-blur-sm overflow-hidden"
                >
                    {/* Glow */}
                    ...
                    <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6 px-8 py-7">
                        <div className="flex flex-col gap-1 text-center sm:text-left">
                            <span className="text-[10px] font-black uppercase tracking-[0.25em] text-primary">Pronto para o próximo passo?</span>
                            <p className="text-white font-bold text-base sm:text-lg leading-snug">
                                Quer um projeto como esse?{' '}
                                <span className="text-slate-400 font-medium">Vamos construir juntos.</span>
                            </p>
                        </div>
                        <div className="flex flex-wrap items-center gap-3 flex-shrink-0">
                            <a
                                href="https://wa.me/5591991266136?text=Olá Ramon, vi seus projetos e quero construir algo assim!"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="button-primary h-12 px-6 text-xs tracking-widest font-black shadow-[0_0_25px_rgba(242,185,13,0.2)] hover:shadow-[0_0_35px_rgba(242,185,13,0.35)] flex items-center gap-2 group"
                            >
                            ...
                            <a
                                href="#contact"
                                className="button-secondary h-12 px-6 text-xs tracking-widest font-black flex items-center gap-2 group"
                            >
                                VER MAIS PROJETOS
